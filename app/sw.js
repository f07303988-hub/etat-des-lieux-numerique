const CACHE_NAME = 'edl-pasly-v3'; // ⚠️ Incrémenter ce numéro à chaque mise à jour importante du code
  ...
  event.respondWith(
    fetch(event.request)
      .then((networkResponse) => {
        ...
        // Le serveur a répondu mais avec une erreur (404, 500, site hors ligne...) :
        // on bascule sur le cache si on en a un, plutôt que d'afficher l'erreur.
